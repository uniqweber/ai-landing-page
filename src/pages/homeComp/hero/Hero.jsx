...
const Hero = () => {
  return (
    <Section className="pt-[12rem] -mt-[5.25rem]" crosses={true} crossesOffset="lg:translate-y-[5.25rem]" customPaddings id="hero">
      <div className="container relative">
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
          ...
          <Button href="#pricing" white className="inline-flex">
            get started
          </Button>
        </div>
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          ...
          <div className="absolute -top-[54%] left-1/2   w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104%]">
            <img src={heroBackground} className="w-full" height={1800} width={1440} alt="hero" />
          </div>
          <BackgroundCircles />
        </div>
